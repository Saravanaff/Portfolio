...
export const SKILLS_TEXT: CommandOutput[] = [
  ...
  { text: "" },
  { text: "  Frameworks & Technologies", color: "text-kitty-cyan" },
  { text: "  ─────────────────────────", color: "text-kitty-gray" },
  { text: "  React, Next.js, Node.js, Express.js", color: "text-kitty-fg" },
  { text: "  GraphQL, Socket.io, WebRTC, LangChain", color: "text-kitty-fg" },
  { text: "" },
  { text: "  Databases & Tools", color: "text-kitty-cyan" },
  { text: "  ─────────────────", color: "text-kitty-gray" },
  { text: "  MySQL, MariaDB, PostgreSQL", color: "text-kitty-fg" },
  { text: "  Sequelize, Docker, Linux, GitHub, Postman", color: "text-kitty-fg" },
];
...
export const CONTACT_TEXT: CommandOutput[] = [
  ...
  { text: "  LinkedIn : linkedin.com/in/saravanaprabhuj", color: "text-kitty-blue" },
  { text: "  GitHub   : github.com/saravanaprabhuj", color: "text-kitty-blue" },
